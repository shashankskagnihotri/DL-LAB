...
class MyWorker(Worker):
    ...
    def get_configspace():
        ...
        learning_rate = CSH.UniformFloatHyperparameter('learning_rate', lower=1e-4, upper=1e-1, default_value='1e-1', log=True)

        batch_size = CSH.UniformFloatHyperparameter('batch_size', lower=16, upper=128, default_value='32', log=True)
